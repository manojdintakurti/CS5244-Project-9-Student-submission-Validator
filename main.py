...
#     """
#     Checks a condition and appends the result to the results list for output file logging.
#
#     Args:
#         condition (bool): The condition to check.
#         message (str): A message describing the test case.
#         input_json (str): The input JSON for the test.
#         points_off (float): The points deducted for a failure.
#         results (list): The list to store result strings for logging.
#     """
#     if not condition:
#         print("here ")
...
#     """
#     Formats the details of a test case for logging.
#
#     Args:
#         title (str): The title or description of the test case.
#         input_json (str): The input JSON for the test.
#
#     Returns:
...
#
#     try:
#         results.append(f"TESTING {host_url}: out of {total_points}\n")
#         results.append(
#             "===============================================================================\nGRADING NOTES\n===============================================================================\n")
...
#
# You can earn partial points even if you fail some tests in a section.
# All scores will be rounded to the nearest integer for grading purposes;
# however to receive full points you must pass all tests. In other words,
# if you fail even 1 test the most you can get is 19.\n""")
#
#         # Fetch a test book
...
#     results.append(f"SCORE for {host_url}: {final_score}/{total_points}\n")
#     return results
#
#
#
...
#     host_url = st.text_input("Enter Host URL:", "http://localhost:8080")
#     if st.button("Run Tests"):
#         with st.spinner("Running tests..."):
#             results = run_tests(host_url)
#         result_text = "\n".join(results)
#         st.text_area("Test Results", result_text, height=500)
#         st.download_button("Download Results", result_text,
#                            file_name="RESULTS-dintakurtisaimanoj-SaiManojBookstoreReactOrder.txt")
#
#
